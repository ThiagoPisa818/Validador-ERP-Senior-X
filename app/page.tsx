                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-3">
                    ...
                    {((selectedType === "produtos" &&
                      ...
                      (selectedType === "pessoas" &&
                        (validationResult.clienteEspecializacao || validationResult.representanteComercial))) && (
                      <div className="space-y-2">
                        <Separator />
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                          ...
                          {selectedType === "pessoas" && validationResult.representanteComercial && (
                            <Button
